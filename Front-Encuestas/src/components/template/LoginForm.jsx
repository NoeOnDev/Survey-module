                        ...
                        <div className={styles.flipCardInner}>
                            <div className={styles.flipCardFront}>
                                ...
                                <form className={styles.flipCardForm} action="">
                                    ...
                                    <div onClick={handleGoogleLogin} className={styles.buttonLog}>
                                        <svg className={styles.iconGoogle} height="56.6934px" id="Layer_1" style={{ enableBackground: 'new 0 0 56.6934 56.6934' }} version="1.1" viewBox="0 0 56.6934 56.6934" width="56.6934px" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
